...
flags.DEFINE_string("word_embedding", "BioWordVec, BERT", "Word embedding layer")
...
#                             batch_size = FLAGS.batch_size, 
                            ...
                            workers = FLAGS.generator_workers,
                            verbose = FLAGS.predict_verbose)
    score_file = open('/data/Bodenreider_UMLS_DL/umls_reproduce/WWW/www_scores.txt', 'w')
    ...
    if FLAGS.PredictionLayer == "Threshold":
        ...
        for i, x in enumerate(predictions):
            ...
            print(y_pred_best_threshold[i], file=score_file)
