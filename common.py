...
class NodeParallel():
    ...
    def run(self):
        ...
        #self.logger.info("Starting %d processes ..."%self.num_processes)
        print("Starting %d processes ..."%self.num_processes)

        self.start()
    
        #self.logger.info("Processes started computing")
        print("Processes started computing")
        self.processing()

        self.logger.info("Processes finished in %d sec."%(time.time() - start_time))
        self.join()
        return
